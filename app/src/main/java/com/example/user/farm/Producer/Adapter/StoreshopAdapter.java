...
public class StoreshopAdapter extends RecyclerView.Adapter<StoreshopAdapter.ViewHolder> {

    private Context context;
    // 使用的畫面配置資源編號
    private int layoutId;

    public StoreshopAdapter(Context context, int layoutId) {
        this.context = context;
        this.layoutId = layoutId;
    }

    @Override
    public StoreshopAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
